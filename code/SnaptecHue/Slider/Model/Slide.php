...
class Slide extends \Magento\Framework\Model\AbstractModel implements \SnaptecHue\Slider\Api\Data\SlideInterface
{
    /**
     * Initialize SnaptecHue Slide Model
     *
     * @return void
     */
    ...
    {
        /* _init($resourceModel) */
        $this->_init('SnaptecHue\Slider\Model\ResourceModel\Slide');
    }
    /**
